...
public partial class Pages_Search : System.Web.UI.Page
{
    ...
    protected void searchVenuebtn_Click(object sender, EventArgs e)
    {
        ...
        while (reader.Read())
        {
            ...
            if (reader.GetString(0).Equals("Wells Library"))
            {
                dynDiv.InnerHtml = "<div class = thumbnail><img src = \"../Style/library.jpg\" /><a href='Venue.aspx?VENUE=" + reader.GetString(0) + "'>" + reader.GetString(0) + "</a></div>";
            } else if (reader.GetString(0).Equals("Luddy Hall"))
            {
                dynDiv.InnerHtml = "<div class = thumbnail><img src = \"../Style/computers.jpg\" /><a href='Venue.aspx?VENUE=" + reader.GetString(0) + "'>" + reader.GetString(0) + "</a></div>";
            } else if (reader.GetString(0).Equals("Informatics Building"))
            {
                dynDiv.InnerHtml = "<div class = thumbnail><img src = \"../Style/computers.jpg\" /><a href='Venue.aspx?VENUE=" + reader.GetString(0) + "'>" + reader.GetString(0) + "</a></div>";
            } else
            {
                dynDiv.InnerHtml = "<div class = thumbnail><img src = \"../Style/building.jpg\" /><a href='Venue.aspx?VENUE=" + reader.GetString(0) + "'>" + reader.GetString(0) + "</a></div>";
            }
