...
<div class="row content" style="transform:translateY(20%);">
    <div class="details col-md-6" style="color: white !important;">
        ...
        <br />
        <asp:Label ID="categorylbl2" runat="server" Text="Category: " CssClass="heading"></asp:Label><asp:Label ID="categorylbl" runat="server" Text=""></asp:Label>
        <br />
        ...
        <br />
        <asp:Label ID="capacitylbl2" runat="server" Text="Spots Left: " CssClass="heading"></asp:Label><asp:Label ID="capacitylbl" runat="server" Text=""></asp:Label>
        <br />
